...
\begin{figure}[!h] 
\centerline{\includegraphics[scale=0.60]{img/activite_tour_ex.gif}}
...
\begin{figure}[!h] 
\centerline{\includegraphics[scale=0.60]{img/activite_jeu_ex.gif}}
   \caption{\label{étiquette} Diagramme d'activité représentant le déroulement d'un tour pour un joueur}
\label{activiteJeu}
\end{figure}
...
\begin{figure}[!h] 
\centerline{\includegraphics[scale=0.60]{img/etata_ex.gif}}
